  ...
  difference() {
    union() {
      intersection() {   // UJoint Arms
        ...
        cube([width, 20, 8], center=true);
        //#translate([0, 0, -20]) cube([width, 20, 10], center=true);
      ...
      intersection() {   // UJoint Arms
        ...
        //#cube([width, 20, 8], center=true);
        translate([0, 15, -30]){
         cube([width, 10, 9], center=true);
        translate([0, -6, 0])rotate([0, 90, 0]) cylinder(r=4.7, h=width, center=true);
        }
      }
      intersection() {
        //translate([0, 18, 4]) rotate([45, 0, 0])
          ...
          cube([width, reinforced+13, reinforced+13], center=true);
                translate([0, 18, -10]) rotate([35, 0, 0])
          cube([width, reinforced+13, reinforced+13], center=true);
          }
        //#translate([0, 0, 20]) cube([width, 35+5, 40+8], center=true);
        translate([0, 0, 20]) cube([width, 35+5, 40+100], center=true);
      }
...
//difference(){
	union(){
		intersection(){
			carriage();
			union() {
				translate([-27,-35,0]) cylinder(r=16, h=50, center=true);
				translate([27,-35,0]) cylinder(r=16, h=50, center=true);
				cube([100, 40, 100], center=true);
				translate([0,0,-13]) cube([50, 100, 10], center=true);
                translate([0,0,-48]) cube([800, 100, 6], center=true);
			}
		}
        translate([-27,-30,0]) magnete();
		translate([27,-30,0]) magnete();
        
        translate([-27,-32,-35]) rotate([75, 0, 0]) magnete();
		translate([27,-32,-35]) rotate([75, 0, 0]) magnete();
        //supporto_carrello();
	}
...
module supporto_carrello(){
    union(){
        translate([27,-20,-22]) cube([10, 10, 10], center=true);
        translate([-27,-20,-22]) cube([10, 10, 10], center=true);
        translate([0,-20,-31]) cube([100, 20, 10], center=true);
    }
}
carrello();