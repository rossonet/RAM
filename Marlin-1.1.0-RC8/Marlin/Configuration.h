...
#define STRING_SPLASH_LINE1 RAM_0.1 // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 www.rossonet.com         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Rossonet Atom Machine"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 390.0 // mm
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 8000, 8000, 8000, 9000 }
...
#define Z_SERVO_ANGLES {18,82} // Z Servo Deploy and Stow angles
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -10.5  // Z offset: -below +above  [the nozzle]
...
#define MANUAL_Z_HOME_POS 510 // Distance between the nozzle to printbed after homing
