...
#define TEMP_SENSOR_AD595_GAIN   0.72
...
#define X_HOME_BUMP_MM 6
#define Y_HOME_BUMP_MM 6
#define Z_HOME_BUMP_MM 6 // deltas need the same for all three axis
...
#define DIGIPOT_MOTOR_CURRENT {155,155,155,155,155} // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
