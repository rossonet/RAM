...
belt_length=smooth_rod_length-motor_end_height-25-idler_end_height/2;
...
module tower(height) {
	translate([0, tower_radius, 0]) {
		...
		rotate([0, 180, 0]) {
			...
			translate([j,0,16])
			//lm8uu(); 
               linear_bearing("KB-12-WW");

		}

		translate([0, 17-10, motor_end_height-25]) nema17(47);
...
module rostock() {
	...
	cube([tower_radius*1.33333, tower_radius*1.33333, pcb_thickness], center=true);
}
