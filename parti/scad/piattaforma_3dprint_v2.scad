...
module passacavi() {
	rotate([0, 0, -15]) translate([ 20, -15, 0]) cylinder(r=3.5,h=2000,center=true);
}
...
module scasso_servo() {
	translate([-12,-12,-2]) cube([24,24,11]);
	...
	translate([-14,0,0.2]) cylinder(r=1.1,h=6,center=true,$fn=120);
	translate([14,0,0.2]) cylinder(r=1.1,h=6,center=true,$fn=120);
}
